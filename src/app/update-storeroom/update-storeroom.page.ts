...
@Component({
  selector: 'app-update-storeroom',
  templateUrl: './update-storeroom.page.html',
  styleUrls: ['./update-storeroom.page.scss'],
})
export class UpdateStoreroomPage implements OnInit {
